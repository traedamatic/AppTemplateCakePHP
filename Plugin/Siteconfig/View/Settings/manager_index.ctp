<div class="view manager form" id="site-settings">
	...
	<h2>Overview of all settings</h2>
	...
	<div class="row">
		<div class="col-md-6">
			<div id="new-setting-form">
				<h2><?php echo __('Create new setting key/value pair') ?></h2>
				<?php
					echo $this->Form->create('SiteSettings',array('url' => array('controller' => 'settings', 'action' => 'add', 'manager' => true)));
					echo $this->Form->input('Setting.namespace',array('class' => 'form-control','div' => 'form-group','type' => 'text', 'label' => __('Namespace')));
					echo $this->Form->input('Setting.key',array('class' => 'form-control','div' => 'form-group','type' => 'text', 'label' => __('Key')));
					echo $this->Form->input('Setting.value',array('class' => 'form-control','div' => 'form-group','type' => 'text','label' => __('Value')));
		...
		<div class="col-md-6">
			<div id="edit-setting-form" style="display: none;">
				...
				<?php
					...
					echo $this->Form->input('Setting.namespace',array('type' => 'hidden', 'label' => __('Namespace'),'class' => 'form-control','div' => 'form-group'));
					echo $this->Form->input('Setting.key',array('class' => 'form-control','div' => 'form-group','type' => 'hidden', 'label' => __('Key')));
					echo $this->Form->input('Setting.value',array('class' => 'form-control','div' => 'form-group','type' => 'text','label' => __('Value')));
					echo $this->Form->button(__('Save'),array('class' => 'btn btn-primary'));
					echo $this->Form->end();
				?>				
